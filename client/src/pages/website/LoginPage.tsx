...
const LoginPage = () =>
{
    return (
        <div>
            <section className="bg-[#ffffff]-900 min-h-screen flex items-center justify-center">
                <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
                    <div className=" md:w-1/2 px-16">
                        <h2 className="font-bold text-2xl text-black">Login</h2>
                        <p className="text-sm mt-4 text-[#adb5bd]">
                        ...
                        <Link to={ "" } className="  mt-5 text-xs border-b border-gray-400 py-4">

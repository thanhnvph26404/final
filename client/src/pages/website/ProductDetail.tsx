...
const ProductDetail = () => {
    ...
    return (
        <div className=" items-center">
                ...
                <div className="flex space-x-[40px]">
                    ...
                    <div className="mt-[50px]">
                        ...
                        <div className="mt-[30px] flex">
                            ...
                            <button className="ml-3" onClick={() => addtowishList(product?.data?._id)}>
                                <HeartFilled className="text-[20px] text-red-500" />
                            </button>
                        </div>
            ...
            <div className="mt-4">
                <h1 className="text-[25px] pl-[145px] text-[#23314b] font-semibold">Sản phẩm cùng loại </h1>
            </div>
                    ...
                    <div key={product._id}>
                        <div className="pl-[90px]  ">
                            <div className="relative w-[200px] ">
                                <img className="w-[150px] pl-[30px] pt-4" src={product.images[0].url} alt="" />
                                {product.original_price && (
                                    <p className="absolute z-10 top-3 left-[100px] bg-[#f83a3a] text-[8px] font-semibold rounded-full text-white px-2 py-[3px]">
                                        Tiết kiệm {(product.price - product.original_price).toLocaleString()} đ
                                    </p>
                                )}
                                <p className="text-center text-[#23314b] text-[15px] font-semibold">{product.name}</p>
                                <p className="text-center text-[10px] font-extralight text-gray-500 space-x-2">
                                    {product.original_price ? (
                                        <>
                                        ...
                                        <span className="text-sm md:text-base font-extralight text-[#23314bb3]">

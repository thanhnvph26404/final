...
const Inspection = () => {
    return (
        <div className='sm:w-[900px] m-auto max-sm:w-[360px] '>
            <h1 className='text-center text-4xl font-semibold font-mono text-[#23314B] mt-5 '>Chính sách kiểm hàng</h1>
            <div>
                <p className='mt-10 text-[#8A919F]'>Bee Fashion luôn hướng tới việc cung cấp dịch vụ giao hàng tốt nhất cho tất cả các đơn hàng của bạn.</p>
                <p className='mt-10 text-[#8A919F]'>Sau khi Quý Khách đặt hàng thành công tại website, chúng tôi sẽ gửi email để thông báo tới Quý Khách, trong đó bao gồm nội dung chi tiết đơn hàng đã đặt thành công và gọi điện xác nhận đơn hàng.</p>
                <p className='mt-10 font-semibold'>Giao nhận hàng hóa - Kiểm hàng trước khi thanh toán:</p>
                <p className='mt-10 text-[#8A919F]'>Trước khi nhận hàng và thanh toán, Quý Khách được quyền kiểm tra sản phẩm. Không hỗ trợ thử hàng.</p>
                <p className='mt-10 text-[#8A919F]'>Quý Khách vui lòng mở gói hàng kiểm tra để đảm bảo đơn hàng được giao đúng mẫu mã, số lượng như đơn hàng đã đặt. Không thử hay dùng thử sản phẩm.</p>

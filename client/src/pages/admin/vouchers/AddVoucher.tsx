...
const AddVoucher = () => {
    ...
    const onSubmit: SubmitHandler<IVoucher> = async (data) => {
        ...
        try {
            ...
            toastError('Thêm mã giảm giá thất bại')
        }
    ...
    return (
        <div>
            ...
            <div className=" h-10">
                <h1 className="text-2xl font-semibold ">Thêm mã giảm giá</h1>
            </div>
            <form action="" onSubmit={handleSubmit(onSubmit)}>
                <div className='max-w-full border-[#E0E2E7] border rounded-lg mx-auto mt-10 bg-white p-6'>
                    <h3 className='text-xl text-[#1D1F2C] font-medium mb-3.5'>Thông tin mã giảm giá </h3>
                    {/* Tên voucher */}
                    <div>
                        <h5 className='text-sm text-[#777980] font-medium'>Tên mã giảm giá</h5>
                        <input type="text" placeholder='Nhập tên mã giảm giá '
                    ...
                    <div className="mb-4">
                        <h5 className='text-sm text-[#777980] font-medium mt-4'>chi tiết mã giảm giá</h5>
                        <textarea placeholder='chi tiết mã giảm giá'
                            className='px-3 py-2 placeholder:text-sm placeholder:text-[#777980] font-normal outline-none border border-[#E0E2E7] rounded-lg w-full mt-1'
                ...
                <div className='h-[72px] border-t bg-white flex items-center justify-end'>
                    <button className='text-white bg-[#858D9D] rounded-lg flex items-center py-2.5 px-3.5 hover:opacity-70'>{isLoadingVoucher ? <AiOutlineLoading3Quarters className='animate-spin' /> : <AiOutlinePlus className='font-semibold text-base mr-1' />} <p className='text-sm font-semibold'>Thêm mã giảm giá</p></button>
                </div>
            </form>
        </div>
    )
